...
public class TileArray {
	...
	// tile lists:
	private LinkedList<Piece> tile00 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile01 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile02 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile03 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile10 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile11 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile12 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile13 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile20 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile21 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile22 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile23 = new LinkedList<Piece>();
	private LinkedList<Piece> tile30 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile31 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile32 = new LinkedList<Piece>(); 
	private LinkedList<Piece> tile33 = new LinkedList<Piece>();   
	...
	public void win() {
		if (Game.gameState == Game.STATE.P1_Choose) {
			Game.gameState = Game.STATE.P1_Wins;
		}
		
		else if (Game.gameState == Game.STATE.P2_Choose) {
			Game.gameState = Game.STATE.P2_Wins;
		}	
	}
